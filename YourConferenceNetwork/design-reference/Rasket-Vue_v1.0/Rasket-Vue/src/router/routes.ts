...
const analysisRoutes = [
    {
        path: '/analysis/datasets',
        name: 'analysis.datasets',
        meta: {
            title: setTitle('My Datasets'),
            authRequired: true
        },
        component: () => import('@/views/analysis/datasets.vue')
    },
    {
        path: '/analysis/upload',
        name: 'analysis.upload',
        meta: {
            title: setTitle('Upload Dataset'),
            authRequired: true
        },
        component: () => import('@/views/analysis/upload.vue')
    },
    {
        path: '/analysis/datasets/:id',
        name: 'analysis.overview',
        meta: {
            title: setTitle('Dataset Overview'),
            authRequired: true
        },
        component: () => import('@/views/analysis/overview.vue')
    },
    {
        path: '/analysis/datasets/:id/chart',
        name: 'analysis.chart',
        meta: {
            title: setTitle('Participation Chart'),
            authRequired: true
        },
        component: () => import('@/views/analysis/chart.vue')
    },
    {
        path: '/analysis/datasets/:id/networks',
        name: 'analysis.networks',
        meta: {
            title: setTitle('Network Maps'),
            authRequired: true
        },
        component: () => import('@/views/analysis/networks.vue')
    },
    {
        path: '/analysis/datasets/:id/exports',
        name: 'analysis.exports',
        meta: {
            title: setTitle('Export Data'),
            authRequired: true
        },
        component: () => import('@/views/analysis/exports.vue')
    },
];
...
const billingRoutes = [
    ...
    },
    {
        ...
        name: 'billing.portal',
        meta: {
            title: setTitle('Manage Subscription'),
            authRequired: true
        },
        component: () => import('@/views/billing/portal.vue')
    },
    {
        path: '/billing/success',
        name: 'billing.success',
        meta: {
            title: setTitle('Subscription Activated'),
            authRequired: true
        },
...
export const allRoutes = [...dashboardRoutes, ...analysisRoutes, ...billingRoutes, ...adminRoutes, ...pagesRoutes, ...errorRoutes, ...authRoutes, ...appsRoutes, ...uiRoutes, ...advancedUIRoutes, ...chartsRoutes, ...formRoutes, ...tablesRoutes, ...iconsRoutes, ...mapsRoutes];
