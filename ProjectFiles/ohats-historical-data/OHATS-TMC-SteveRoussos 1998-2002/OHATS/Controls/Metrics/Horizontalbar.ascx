<%@ control language="C#" autoeventwireup="true" inherits="Metrics_Horizontalbar, App_Web_horizontalbar.ascx.68e27dd6" %>
...
<zgw:EventGraphweb id="EventGraphWeb1" runat="server" RenderMode="ImageTag"
            Width="440" Height="320" RenderedImagePath="EventGraphImges" >
