<%@ control language="C#" autoeventwireup="true" inherits="Metrics_InitialPie, App_Web_initialpie.ascx.68e27dd6" %>
<%@ Register TagPrefix="zgw" Namespace="EventGraph.Web" Assembly="EventGraph.Web" %>

<zgw:EventGraphweb id="EventGraphWeb1" runat="server" RenderMode="ImageTag"   Width="440" Height="400" RenderedImagePath="EventGraphImges" >
