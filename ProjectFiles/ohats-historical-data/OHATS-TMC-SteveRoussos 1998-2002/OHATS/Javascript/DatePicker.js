...
function fnShowCalendar(objControl, ctrlName) {
    var intTop, intLeft;
    if (document.getElementById(ctrlName).disabled == true) return;
    
    this.ctrlName = ctrlName;
    if (ctrlName == "ctl00_Main_txtFromdate") {
        this.dateType = "From";
        this.dateValue = document.getElementById("ctl00_Main_txtTodate").value;
    }
    else if (ctrlName == "ctl00_Main_txtTodate") {
        this.dateType = "To";
        this.dateValue = document.getElementById("ctl00_Main_txtFromdate").value;
    }
    else {
        this.dateType = "";
        this.dateValue = "";
    ...
    var strDate = document.getElementById(ctrlName).value.split("/");
...
function fnSetValue(dtDate) {
    ...
    if (isValid) {
        ...
        document.all(ctrlName).value = dtDate;
        oPopup.hide();
    }
}
