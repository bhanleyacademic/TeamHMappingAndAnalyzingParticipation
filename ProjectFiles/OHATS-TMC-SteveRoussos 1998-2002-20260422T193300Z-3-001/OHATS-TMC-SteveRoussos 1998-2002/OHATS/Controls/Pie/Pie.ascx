<%@ control language="C#" autoeventwireup="true" inherits="Pie_EMDemo, App_Web_pie.ascx.4a8ab9a2" %>
<%@ Register TagPrefix="zgw" Namespace="EventGraph.Web" Assembly="EventGraph.Web" %>

<zgw:EventGraphweb id="EventGraphWeb1" runat="server" RenderMode="ImageTag" RenderedImagePath="EventGraphImges" Height="350" Width="380" >
