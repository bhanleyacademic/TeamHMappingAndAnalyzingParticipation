<%@ control language="C#" autoeventwireup="true" inherits="Metrics_Bar, App_Web_bar.ascx.68e27dd6" %>
...
<zgw:EventGraphweb id="EventGraphWeb1" runat="server" RenderMode="ImageTag" 
            Width="440" Height="450" BarType="Cluster" TmpImageDuration="50" RenderedImagePath="EventGraphImges"  
            >
