<%@ control language="C#" autoeventwireup="true" inherits="PieChat, App_Web_pie.ascx.cc671b29" %>
<%@ Register TagPrefix="zgw" Namespace="EventGraph.Web" Assembly="EventGraph.Web" %>



<zgw:EventGraphweb id="EventGraphWeb1" runat="server"
              Width="440" Height="400" RenderedImagePath="EventGraphImges" >
