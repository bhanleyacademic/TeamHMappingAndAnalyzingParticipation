<%@ page language="C#" masterpagefile="Event.master" autoeventwireup="true" inherits="Default3, App_Web_advancedmetrics.aspx.cdcab7d2" %>

<%@ Register Src="Controls/PieEvents/Pie.ascx" TagName="Pie" TagPrefix="uc1" %>
<%--<%@ Register Src="Controls/Pie/Pie.ascx" TagName="Pie" TagPrefix="uc1" %>--%>
<%--<%@ Register Src="Controls/Innovation.ascx" TagName="Innovation" TagPrefix="uc1" %>--%>
        ...
        <tr>
            <td align="center" style="padding-left: 0px;">
                <table width="90%" cellpadding="0" cellspacing="0" border="0" align="center">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="90%">
                                <tr>
                                    <td valign="top" style="padding-bottom:20px;padding-top:0px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #BBC7E5;background: #DEE6F0;" id="TABLE1" onclick="return TABLE1_onclick()">
                                            <tr>
                                                <td nowrap style="padding:20px 15px 0px 19px; width: 125px;" valign="top">
                                                ...
                                                <td style="padding: 15px 0px 0px 0px;" valign="top">
                                                    <span style="float: left;">
                                                        <asp:DropDownList CssClass="advancemetdrop"  ID="drop" runat="server" Height="25px" Style="float: left;"
                                            ...
                                            <tr>
                                                <td style="width: 125px; padding: 5px 0px 0px 10px;" valign="top">
                                                    <asp:Label ID="lbleventtype" Text="Choose Event Type" runat="server" Style="float: left;
                                                        margin-left: 12px; font: bold 12px arial; color: #525251" Visible="false"> </asp:Label>
                                                </td>
                                                <td style="" valign="top">
                                                    <span style="float: left;padding:5px 0px 15px 0px;">
                                                        <asp:DropDownList CssClass="advancemetdrop"  ID="dropeventtype" runat="server" Height="25px" Width="170px" Style="float: left;" Visible="false" OnSelectedIndexChanged="dropeventtype_SelectedIndexChanged"
                                                            AutoPostBack="true">
                                ...
                                <tr>
                                    <td valign="top" style="padding-bottom:5px;padding-top:5px;">
                                        <table  border="0" cellpadding="0" cellspacing="0" width="400px"  style="border: 1px solid #BBC7E5; height:150px;
                                            margin: 0px 0px 1px 0px; padding: 0px 0px 1px 0px; background: #DEE6F0;" id="TABLE2"
                                            ...
                                            <tr>
                                                <td width="280" colspan="2" align="center" valign="bottom" style="height: 24px; padding-left: 85px;padding-bottom: 10px; padding-right: 80px;">
                    ...
                    <tr>
                        <td valign="top" colspan="2">
                            <table border="0" cellpadding="0" cellspacing="0" style="float:left;width:50%;clear:left;position:relative;margin:-71px 0px 0px 6px; display: inline; top:0px;
                                left: -5px;">
                                <tr>
                                    <td valign="top" align="center" style="font:22px geogia,arial;color: red;width:400px;padding: 4px 0px 19px 5px;" >
                                        METRICS DESCRIPTION
                                        </td>
                            ...
                            <asp:Panel ID="linetype" runat="server" Visible="false">
                                <div style="font: 12px arial; float: left; clear: left;width: 400px; text-align: justify;
                                    border: 1px solid #BBC7E5; background: #DEE6F0; padding: 10px 5px 10px 5px;"
                            ...
                            <asp:Panel ID="planning" runat="server" Visible="false">
                                <div style="float: left; clear: left;width: 400px; text-align: justify; font: 12px arial;
                                    ...
                                    <span><b><u>Event Summary </u></b>
                                        <br />
                                        <br />
                                        The total planning development events are represented over a period of year.
                                    </span>
                                </div>
                            </asp:Panel>
                            </td></tr></table>
